function About() {
  return (
    <div className="flex justify-center items-center max-w-7xl min-h-[80%] bg-slate-500 text-slate-700 sm:text-sm tracking-widest p-12 border-y-2 rounded-xl border-amber-600/50 xl:text-xl">
      <p>
